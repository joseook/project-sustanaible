        ...
        <section className="bg-center bg-cover bg-no-repeat bg-wavy-shape">
          <div className="container mx-auto mt-12">
            <div className="flex flex-col gap-4">
              <h1 className="font-bold xl:text-5xl text-3xl  xl:text-left lg:text-left text-center">
                Investindo em um
            ...
            <div className="card-box xl:flex lg:flex justify-center items-center gap-12">
              <div className="card-field shadow-2xl p-12 gap-4 transform hover:scale-110 delay-150 transition-transform ease-in-out bg-no-repeat bg-cover bg-center bg-body-card rounded-lg text-white ">
                <span>Economia</span>
              ...
              <div className="card-field shadow-2xl p-12 gap-4 md:mt-4 sm:mt-4 xs:mt-4 transform hover:scale-110 delay-150 transition-transform ease-in-out  bg-no-repeat bg-cover bg-center bg-body-card02 rounded-lg ">
